...
<div class="container p-3 my-3 bg-light text-dark">
	<c:choose>
		<c:when test = "${promotionPanier.typeReduc=='valeur'}">
	       <c:set var = "signe" scope = "session" value = "${'cts'}"/>
	   </c:when>
	   <c:when test = "${promotionPanier.typeReduc=='pourcentage'}">
   ...
   <c:otherwise>
	   ...
	   <p> Le code "${promotionPanier.codePromo}" ajoutera une promotion de ${promotionPanier.valeur}${signe} sur un panier.</p>
   </c:otherwise>
   </c:choose>
